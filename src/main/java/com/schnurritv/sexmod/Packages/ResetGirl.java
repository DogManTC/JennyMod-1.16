        ...
        public IMessage onMessage(ResetGirl message, MessageContext ctx) {
            if (message.messageValid && ctx.side == Side.SERVER) {
                ...
                for (GirlEntity girl : girls) {
                    if (girl.field_70170_p.field_72995_K) continue;
                    try {
                    ...
                    if (message.onlyDoPlayerPart) continue;
                    ...
                    girl.func_70634_a(girl.func_174791_d().field_72450_a, girl.func_180425_c().func_177956_o(), girl.func_174791_d().field_72449_c);
                }
            } else {
